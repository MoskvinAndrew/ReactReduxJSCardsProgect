...
import style from "./testMonst.module.css";
        ...
        <div className={style.wrapper}>
            <div className={style.block12wrapp}>
                ...
                <div className={style.block2}
                     ...
                     onMouseOver={() => onMouseOverBlock(`${style.dot2Scope}`, `${style.dot2ScopeSecond}`)}></div>

            </div>
            <div className={style.block34wrapp}>
                <div className={style.wrapperImg}
                     onMouseOver={() => onMouseOverBlock(`${style.dot}`, `${style.dotSecond}`)}><img src={monsterPic}/>
                    <img className={styler} src={dot}/>
                    <img className={stylerSecond} src={dot}/>
                </div>

                <div className={style.block3}
                     onMouseOver={() => onMouseOverBlock(`${style.dot3Scope}`, `${style.dot3ScopeSecond}`)}></div>
            </div>
